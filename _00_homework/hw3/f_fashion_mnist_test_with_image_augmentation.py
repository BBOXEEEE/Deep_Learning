...
from _00_homework.hw3.d_fashion_mnist_data_with_image_augmentation import get_augmented_fashion_mnist_test_data


def main():
  fashion_mnist_test_images, test_data_loader, fashion_mnist_transforms = get_augmented_fashion_mnist_test_data()
